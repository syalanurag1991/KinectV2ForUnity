...
public class KinectDisplay : MonoBehaviour
{
	...
	void Start()
	{
		lowResolutionKinectDataInstance = KinectManager.Instance.GetLowResolutionKinectData();
		fullResolutionKinectDataInstance = KinectManager.Instance.GetFullResolutionKinectData();
